...
#include "ferenstyle.h"

#include "feren.h"
#include "ferenanimations.h"
#include "ferenframeshadow.h"
#include "ferenmdiwindowshadow.h"
#include "ferenmnemonics.h"
#include "ferenpropertynames.h"
#include "ferenshadowhelper.h"
...
namespace FerenPrivate
{
    ...
    class TabBarData: public QObject
    {
        ...
        Feren::WeakPointer<const QWidget> _tabBar;
    ...
    class ComboBoxItemDelegate: public QItemDelegate
    {
        ...
        explicit ComboBoxItemDelegate( QAbstractItemView* parent ):
            ...
            _itemMargin( Feren::Metrics::ItemView_ItemMarginWidth )
        {}
        ...
        //* proxy
        Feren::WeakPointer<QAbstractItemDelegate> _proxy;
...
//             QStringLiteral( "reparseConfiguration" ), this, SLOT(configurationChanged()) );
    ...
    void Style::polish( QWidget* widget )
    {
        ...
        if( qobject_cast<QScrollBar*>( widget ) )
        {
            ...
            if( !hasParent( widget, "QWebView" ) )
            {
                ...
                { itemView->setItemDelegate( new FerenPrivate::ComboBoxItemDelegate( itemView ) ); }
            }
    ...
    QRect Style::progressBarGrooveRect( const QStyleOption* option, const QWidget* widget ) const
    {
        ...
        const bool horizontal( FerenPrivate::isProgressBarHorizontal( progressBarOption ) );
